...
## BoilerPlates 
If you would like a popup boilerplate, clone the `boilerplate/HR8.5_New_Tab_Extension` directory.
  
If you would like a new tab boilerplate, clone the `boilerplate/HR8.5_Popup` directory.
